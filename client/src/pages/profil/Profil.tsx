    ...
    <section className={styles.profil}>
      ...
      <section className={styles.profil__formSection}>
        ...
        <form className={styles.profil__form}>
          ...
          <input type="text" id="firstName" className={styles.profil__input} />

          <label htmlFor="lastName" className={styles.profil__label}>
            Nom
          </label>
          <input type="text" id="lastName" className={styles.profil__input} />

          <label htmlFor="email" className={styles.profil__label}>
            Email
          </label>
          <input type="email" id="email" className={styles.profil__input} />
